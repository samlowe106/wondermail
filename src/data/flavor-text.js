...
export const PARENT_CHILD = [
 [
  15,
  13,
  "Please rescue Weedle! <!--break-->He's my son! Please!"
 ],
 [
  18,
  16,
  "Oh, my cute little Pidgey! <!--break-->Please, someone help!"
 ],
 [
  20,
  19,
  "Rattata is missing! My precious child! <!--break-->Please, won't someone help me?"
 ],
 [
  26,
  172,
  "Please rescue Pichu! He's a little cutie <!--break-->who can't charge power well yet. Please!"
 ],
 [
  36,
  173,
  "Cleffa disappeared! Please let me know <!--break-->if you find my child!"
 ],
 [
  40,
  174,
  "Please find Igglybuff! Oh, where did that <!--break-->child roll off to?! Oh!"
 ],
 [
  169,
  41,
  "Please rescue Zubat! He's so young he <!--break-->can't even hang from cavern ceilings well!"
 ],
 [
  45,
  43,
  "Oddish disappeared from sight! She may be <!--break-->buried somewhere! Someone, please help!"
 ],
 [
  62,
  60,
  "My baby Poliwag! He wandered off... <!--break-->He only just learned how to walk! Help!"
 ],
 [
  176,
  175,
  "Help! Togepi's just a baby! <!--break-->I'm worried sick! Please help!"
 ],
 [
  184,
  323,
  "Please save my adorable Azurill! <!--break-->Watch for a round and bouncy tail!"
 ],
 [
  242,
  241,
  "Please find Teddiursa! My baby's head <!--break-->has a cute crescent mark! Help!"
 ],
 [
  257,
  256,
  "Please look for Phanpy! <!--break-->My son has a distinctive long nose!"
 ],
 [
  125,
  264,
  "My son can be wild with thunderbolts, <!--break-->but he's kindhearted. Please help!"
 ],
 [
  126,
  265,
  "My baby Magby is lost. I'm worried sick. <!--break-->She's a cheerful child who loves fire."
 ],
 [
  273,
  271,
  "Please search for Larvitar! <!--break-->He loves to eat dirt! I need help!"
 ],
 [
  292,
  290,
  "My Wurmple went missing! Please look <!--break-->for the cute spikes on his rear end!"
 ],
 [
  331,
  329,
  "Please find my Aron! <!--break-->He's my only child! Please help!"
 ],
 [
  355,
  353,
  "Please find my little Trapinch! <!--break-->My baby is probably lying low!"
 ],
 [
  393,
  391,
  "Save my baby Spheal! My baby is easy to <!--break-->spot because she likes to roll!"
 ],
 [
  302,
  301,
  "Please look for Taillow! <!--break-->My baby is very timid, so I'm worried!"
 ]
];
...
export const MANKEY = "Please punish bad Mankey's gang.";

export const SMEARGLE = "I didn't want to become a grown-up, so I <!--break-->fled, but now I've lost my way! Help!";

export const MEDICHAM = "This is Medicham. Rescue me, please! <!--break-->The reward is a secret~♪ ";

export const TEXT_4 = "With the item %s, I can <!--break-->evolve! I'm yearning to evolve! Help!";

export const TEXT_5 = "The %s! What I love to eat <!--break-->and can't live without! Please get one!";

export const TEXT_9 = "This is a rescue through communication. <!--break-->Get a friend to help you!";

export const TEXT_10 = "This is a rescue through communication. <!--break-->Rescue a friend!";

export const TEXT_11 = "This is a rescue through communication. <!--break-->Send your thanks to your friend!";

export const MANKEY_TITLE = "Punish bad Mankey!";

export const SMEARGLE_TITLE = "Smeargle's desperate plea!";

export const MEDICHAM_TITLE = "Medicham: Help me!";

export const TITLE_4 = "Save my child!";

export const TITLE_6 = "Escort me to my love!";

export const TITLE_7 = "Deliver one %s.";

export const TITLE_8 = [
 "Help!",
 "I can't get out!",
 "I'm in trouble...",
 "I'm scared!",
...
export const TITLE_11 = "One %s wanted!";

export const TITLE_12 = "Deliver one %s.";
